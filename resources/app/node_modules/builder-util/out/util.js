...
function executeAppBuilder(args, childProcessConsumer, extraOptions = {}) {
  return new Promise((resolve, reject) => {
    ...
    const env = Object.assign({
      ...
      SNAP_USE_HARD_LINKS_IF_POSSIBLE: _isCi().default.toString()
    }, process.env, {
      SZA_PATH: _zipBin().path7za,
      FORCE_COLOR: _chalk().default.enabled ? "1" : "0"
    });
    ...
    const childProcess = doSpawn(command, args, Object.assign({}, extraOptions, {
      env,
