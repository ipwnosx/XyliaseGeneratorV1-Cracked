...
function doBuild(_x) {
  return _doBuild.apply(this, arguments);
}

function _doBuild() {
  _doBuild = (0, _bluebirdLst().coroutine)(function* (data) {
    ...
    yield (0, _fsExtraP().writeFile)(path.join(process.env.APP_BUILDER_TMP_DIR, "__build-result.json"), JSON.stringify(artifacts));
  });
  return _doBuild.apply(this, arguments);
}
