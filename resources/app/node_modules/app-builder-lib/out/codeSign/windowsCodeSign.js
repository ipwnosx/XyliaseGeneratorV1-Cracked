...
function _sign() {
  _sign = (0, _bluebirdLst().coroutine)(function* (options, packager) {
...
function getCertInfo(_x3, _x4) {
  return _getCertInfo.apply(this, arguments);
}

function _getCertInfo() {
  _getCertInfo = (0, _bluebirdLst().coroutine)(function* (file, password) {
    let result = null;

    try {
      result = yield (0, _appBuilder().executeAppBuilderAsJson)(["certificate-info", "--input", file, "--password", password]);
    } catch (e) {
...
function getCertificateFromStoreInfo(_x5, _x6) {
  return _getCertificateFromStoreInfo.apply(this, arguments);
}

function _getCertificateFromStoreInfo() {
  _getCertificateFromStoreInfo = (0, _bluebirdLst().coroutine)(function* (options, vm) {
...
function doSign(_x7, _x8) {
  return _doSign.apply(this, arguments);
} // on windows be aware of http://stackoverflow.com/a/32640183/1910191


function _doSign() {
  _doSign = (0, _bluebirdLst().coroutine)(function* (configuration, packager) {
...
function getToolPath() {
  return _getToolPath.apply(this, arguments);
} function _getToolPath() {
  _getToolPath = (0, _bluebirdLst().coroutine)(function* () {
