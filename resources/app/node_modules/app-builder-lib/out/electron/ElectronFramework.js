...
function beforeCopyExtraFiles(_x) {
  return _beforeCopyExtraFiles.apply(this, arguments);
}

function _beforeCopyExtraFiles() {
  _beforeCopyExtraFiles = (0, _bluebirdLst().coroutine)(function* (options) {
...
function createElectronFrameworkSupport(_x2, _x3) {
